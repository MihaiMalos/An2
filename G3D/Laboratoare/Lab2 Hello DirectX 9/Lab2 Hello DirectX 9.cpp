...
void InitD3D(HWND hWnd)
{
	...
	double screen_width = windowRect.right - windowRect.left;
	double screen_height = windowRect.bottom - windowRect.top;
	double delta_width = screen_width / 10.0;
	double delta_height = screen_height / 10.0;
...
void RenderFrame(void)
{
	...
	d3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(0, 80, 40), 1.0f, 0);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INPUT:
	{
		...
		GetRawInputData((HRAWINPUT)lParam, RID_INPUT, lpb, &iBuffer, sizeof(RAWINPUTHEADER));
